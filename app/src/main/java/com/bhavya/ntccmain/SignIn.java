...
import com.bhavya.ntccmain.databinding.ActivitySignInBinding;
...
public class SignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd.setTitle("LogIn");
        pd.setMessage("Login in your account.....");
        ...
        binding.buttonGoogle2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                signIn();
            }
