...
import com.bhavya.ntccmain.databinding.ActivityWelcomScBinding;
...
public class Verification extends AppCompatActivity {
    ...
    ActivityWelcomScBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityWelcomScBinding.inflate(getLayoutInflater());
        ...
        pd = new ProgressDialog(Verification.this);
        pd.setTitle("Creating Account....");
        pd.setMessage("Account creation in progress.....");
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    User user = new User(binding.etUsername.getText().toString(), binding.etEmailAddress.getText().toString(),
                                            binding.etPassword.getText().toString());

                                    String id = task.getResult().getUser().getUid();
                                    database.getReference().child("Users").child(id).setValue(user);

                                    Toast.makeText(Verification.this, "User created successfully", Toast.LENGTH_LONG).show();
                                } else {
